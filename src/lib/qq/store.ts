...
const initialState = {
  ...
  messages: [
    ...
    { id: "MSG-3", contractId: "QQ-0680", from: "system", fromName: "QuickQuid", text: "Contract QQ-0680 completed. All milestones accepted. Payout processed.", at: "2025-01-17T10:00:00Z" },
    { id: "MSG-4", contractId: "QQ-0680", from: "buyer", fromName: "Northstar Labs", text: "Akhil, great work on the ops console. The design tokens are exactly what we needed.", at: "2025-01-17T10:30:00Z" },
    { id: "MSG-5", contractId: "QQ-0680", from: "pro", fromName: "Akhil Menon", text: "Thank you! Really enjoyed working on this. Let me know if you need any adjustments during the defect window.", at: "2025-01-17T11:00:00Z" },
    { id: "MSG-6", contractId: "QQ-0725", from: "system", fromName: "QuickQuid", text: "Contract QQ-0725 accepted. Funding confirmed for M1. Work may begin.", at: "2025-01-08T10:00:00Z" },
    { id: "MSG-7", contractId: "QQ-0725", from: "pro", fromName: "Priya Nair", text: "Hi Northstar team, I've started on the dashboard audit. Will share the first draft by end of week.", at: "2025-01-08T14:00:00Z" },
    { id: "MSG-8", contractId: "QQ-0725", from: "buyer", fromName: "Northstar Labs", text: "Sounds good. We're particularly interested in the filter states and empty states.", at: "2025-01-08T15:00:00Z" },
    { id: "MSG-9", contractId: "QQ-0725", from: "pro", fromName: "Priya Nair", text: "Got it. I'll make sure those are covered in v1.", at: "2025-01-08T15:30:00Z" },
    { id: "MSG-10", contractId: "QQ-0725", from: "buyer", fromName: "Northstar Labs", text: "The hi-fi v1 looks good but I don't see the filter active/empty/loading states. These are essential.", at: "2025-01-15T12:00:00Z" },
    { id: "MSG-11", contractId: "QQ-0725", from: "pro", fromName: "Priya Nair", text: "Those weren't explicitly in the acceptance criteria. I can add them for an additional ₹5,000.", at: "2025-01-15T13:00:00Z" },
    { id: "MSG-12", contractId: "QQ-0725", from: "system", fromName: "QuickQuid", text: "Dispute DSP-7002 opened. Direct dispute chat is paused while evidence is reviewed.", at: "2025-01-16T14:00:00Z" },
  ] as Message[],
