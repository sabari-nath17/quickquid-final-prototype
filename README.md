...
- Pro workflows for profiles, skill evidence, briefs, proposals, contracts, gigs, payout readiness, delivery, and reviews. Seeded prototype Pros open directly into their dashboards and public profiles include live public GitHub profile/repository metadata (avatar, bio, stars, forks, topics, license, and recent update time) plus rich provider-shaped LinkedIn, Behance, and portfolio fixtures: identity/avatar, current experience, optional education, self-declared certificate records, and visual project cards. Every seeded Pro includes a complete profile fixture, public-proof links, portfolio references, and reviewable skill evidence; cards marked `Demo sync` are synthetic and must be replaced before production.
